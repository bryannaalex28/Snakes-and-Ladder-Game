...
def draw_board(screen):
    tile_num = 1  # Start at 1
    for row in range(ROWS - 1, -1, -1):  # Start from bottom row (ROWS-1) up to 0
        # Determine if this row is left-to-right or right-to-left
        if (ROWS - row) % 2 == 1:
        ...
        for col in col_range:
            ...
            # Draw the tile number (correct numbering)
